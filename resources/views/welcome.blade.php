...
@section('storecontent')
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-6  col-sm-8 col-lg-5  col-xs-12 col-md-push-3  col-sm-push-3  col-lg-push-3">
                    <div style="color: #01A4E0; font-size: 20px">Stores</div>
                    <div class="mypaginate" lang="{{$language}}">
                        ...
                        <div  class="col-md-6  col-sm-8 col-lg-5  col-xs-12 col-md-push-3  col-sm-push-3  col-lg-push-3 col-xs-push-5 addpagination">
                            {{ $stores->links() }}
                        </div>
                    </div>
                </div>
